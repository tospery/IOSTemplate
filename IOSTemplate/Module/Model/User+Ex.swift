...
//    }
//    
//    var companyModel: ModelType {
//        var company = self.company
//        if company?.isEmpty ?? true {
//            company = R.string.localizable.noneCompany(preferredLanguages: myLangs)
//        }
//        let companies = company?.matched(pattern: "@([^@\\s]+)") ?? []
//        var links = [String: String].init()
//        for name in companies {
//            let username = name.removingPrefix("@")
//            if username.isNotEmpty {
//                links[name] = Router.shared.urlString(host: .user, path: username)
//            }
//        }
//        return BaseModel.init(
//            SectionItemElement.userCompany(
//                .init(
//                    attributedText: company?.styled(
//                        with: .font(.normal(HiIOS.Metric.Simple.titleFontSize)), .color(.title)
//                    ),
//                    alignment: .left,
//                    links: links,
//                    color: .light
...
//        .composed(of: [
//            count.decimalText.styled(with: .color(.foreground), .font(.bold(22))),
//            Special.nextLine,
