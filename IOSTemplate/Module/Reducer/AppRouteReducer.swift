...
//        @Presents var search: SearchReducer.State?
//        @Presents var trendingOptions: TrendingOptionsReducer.State?
        ...
        var path = StackState<IOSTemplate.Path.State>()
...
//            && lhs.login == rhs.login
//            && lhs.trendingOptions == rhs.trendingOptions
...
//        case trendingOptions(PresentationAction<TrendingOptionsReducer.Action>)
        ...
        case path(StackActionOf<IOSTemplate.Path>)
...
//                }
            ...
            case let .toastMessage(message):
                ...
                return .none
            case let .path(.element(id: _, action: .about(.target(target)))):
                return .run { send in
...
//                let .push(.element(id: _, action: .profile(.target(target)))),
//                let .push(.element(id: _, action: .modification(.target(target)))),
//                let .push(.element(id: _, action: .colorThemeList(.target(target)))),
//                let .push(.element(id: _, action: .localizationList(.target(target)))),
//                let .push(.element(id: _, action: .urlSchemeList(.target(target)))),
//                let .push(.element(id: _, action: .feedback(.target(target)))),
//                let .push(.element(id: _, action: .trendingSinceList(.target(target)))),
//                let .push(.element(id: _, action: .languageList(.target(target)))),
//                let .push(.element(id: _, action: .searchOptions(.target(target)))),
//                let .push(.element(id: _, action: .searchTypeList(.target(target)))),
//                let .push(.element(id: _, action: .page(.target(target)))),
//                let .push(.element(id: _, action: .contentList(.target(target)))),
//                let .push(.element(id: _, action: .code(.target(target)))),
//                let .push(.element(id: _, action: .markdown(.target(target)))),
//                let .push(.element(id: _, action: .user(.target(target)))),
//                let .push(.element(id: _, action: .repo(.target(target)))):
//                return .run { send in
//                    await send(.target(target))
//                }
...
//        }
    ...
    func routeForwardPush(
        ...
        guard let path = result as? IOSTemplate.Path.State else { return nil }
        if should {
