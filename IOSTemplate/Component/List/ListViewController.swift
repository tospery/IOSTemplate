...
class ListViewController: GeneralViewController {
    ...
    struct Reusable {
        ...
        static let userCompanyCell = ReusableCell<UserCompanyCell>()
    ...
    override func viewDidLoad() {
        ...
        self.collectionView.register(Reusable.userCompanyCell)
...
//            .disposed(by: self.disposeBag)
    ...
    func cell(
        ...
        case let .label(item):
            ...
            cell.rx.click
                ...
                .disposed(by: cell.disposeBag)
            return cell
        case let .userCompany(item):
            let cell = collectionView.dequeue(Reusable.userCompanyCell, for: indexPath)
            item.parent = self.reactor
            cell.reactor = item
            cell.rx.click
                .subscribeNext(weak: self, type(of: self).handleTarget)
    ...
    override func collectionView(
        ...
        case let .userCompany(item): return Reusable.userCompanyCell.class.size(width: width, item: item)
        }
    }
